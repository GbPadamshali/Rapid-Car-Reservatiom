                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form role="form" action="{{ route('users.store') }}" id="store_user" name="store_user" method="post">
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Phone</label>
                                        <input type="text" class="form-control" name="phone" id="phone" placeholder="12243453">
