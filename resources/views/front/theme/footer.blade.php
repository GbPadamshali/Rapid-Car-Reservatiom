                  ...
                  <div class="col-lg-4">
                     <div class="single-footer">
                        <div class="footer-logo">
                           <a href="#">
                           <img src="{{ URL::asset('theme/front/img/logo(new).png') }}" alt="footer-logo" />
                           </a>
                        </div>
                        ...
                        <ul>
                           <li>
                              <div class="single-footer-post">
                                 <div class="footer-post-image">
                                    <a href="#">
                                    <img src="{{ URL::asset('theme/front/img/post-thumb-3.jpg') }}" alt="footer post" />
                                    </a>
                                 </div>
                           ...
                           <li>
                              <div class="single-footer-post">
                                 <div class="footer-post-image">
                                    <a href="#">
                                    <img src="{{ URL::asset('theme/front/img/post-thumb-2.jpg') }}" alt="footer post" />
                                    </a>
                                 </div>
                                 <div class="footer-post-text">
                                    <h3>
                           ...
                           <li>
                              <div class="single-footer-post">
                                 <div class="footer-post-image">
                                    <a href="#">
                                    <img src="{{ URL::asset('theme/front/img/post-thumb-1.jpg') }}" alt="footer post" />
                                    </a>
                                 </div>
                                 <div class="footer-post-text">
                                    <h3>
